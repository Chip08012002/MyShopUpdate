...
function updateTotal() {
    ...
    document.getElementById('cart-icon').setAttribute('data-quantity', cartBoxes.length);
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    cart.addEventListener("scroll", function() {
      // Kiểm tra xem thanh trượt đã đến cuối cùng chưa
      if (cart.scrollTop === (cart.scrollHeight - cart.offsetHeight)) {
        // Gọi hàm để tải thêm nội dung
